	...
	<div class="grid-container">
		...
		<div class="grid-item" id="about-section">
			...
			<p>
				...
				doing creative projects, programming, and learning new things. Also, I'm actively learning
				Japanese at the moment, with the plan to be fluent in not only <span
					style:color="var(--accent-main)">Japanese</span
				> but Spanish and a few other lanugages.
			</p>
			<h2>Languages</h2>
			<ul>
		...
		<div class="grid-item" id="work-section">
			...
			<div>
				...
				<p>
					Designed in Affinity Designer with the purpose of making it easier to share my information
					and give a unique first impression.
				</p>
			</div>
		...
		<div class="grid-item" id="info-section">
			...
			<p>Copyright &copy {year} - Made with care</p>
		</div>
	</div>
</div>
